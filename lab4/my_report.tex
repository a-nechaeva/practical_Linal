...
\end{pmatrix}
\end{equation}
Собственные числа $\lambda_1 = \lambda_2 = -5$,\\ собственные векторы $v_1 = \begin{pmatrix} a \\ 0 \end{pmatrix}$,  $v_2 = \begin{pmatrix} b \\ 0 \end{pmatrix}$, $a, b \in \mathbb{R}$.
...
Собственные числа: $\lambda_1 = 4, \, \lambda_2 = 4$, собственные векторы соответственно $v_1 = \begin{pmatrix} a \\ 0 \end{pmatrix}$,  $v_2 = \begin{pmatrix} b \\ 0 \end{pmatrix}$, $a, b \in \mathbb{R}$.
